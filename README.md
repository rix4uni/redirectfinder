...
```
wget https://github.com/rix4uni/redirectfinder/releases/download/v0.0.1/redirectfinder-linux-amd64-0.0.1.tgz
tar -xvzf redirectfinder-linux-amd64-0.0.1.tgz
rm -rf redirectfinder-linux-amd64-0.0.1.tgz
